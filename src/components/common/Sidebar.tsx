...
export const Sidebar: React.FC = () => {
  const { activeModule, setActiveModule, tasks, attendance } = useAppData();
  ...
  return (
    <aside className="w-64 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-r border-slate-200 dark:border-slate-800/80 flex flex-col h-screen sticky top-0 z-30 transition-colors">
      {/* Brand Header */}
